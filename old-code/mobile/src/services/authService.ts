...
try {
	...
	console.log(
		"Google Sign-In not available in this environment (requires development build)",
	);
}
...
const GOOGLE_ANDROID_CLIENT_ID =
	"your-google-android-client-id.googleusercontent.com";
...
export class AuthService {
	...
	static async signInWithGoogle() {
		if (!GoogleSignin) {
			...
			return {
				success: false,
				message: "Google Sign-In requires development build",
			};
		}
		...
		try {
			...
			const initialized = await AuthService.initializeGoogleSignIn();
			if (!initialized) {
