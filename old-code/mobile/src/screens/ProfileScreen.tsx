...
export default function ProfileScreen({ navigation }: ProfileScreenProps) {
	...
	const getProgressPercentage = () => {
		...
		const currentLevel = getCurrentLevel();
		return (
			getProgressToNextLevel(userStats.experience, currentLevel.level) * 100
		);
	};
				...
				<View style={styles.statsContainer}>
					<View style={styles.statCard}>
						...
						<Text style={styles.statNumber}>
							{loading
								? "..."
								: userStats?.issuesReported || basicStats.issuesReported}
						</Text>
					...
					<View style={styles.statCard}>
						...
						<Text style={styles.statNumber}>
							{loading ? "..." : basicStats.issuesResolved}
						</Text>
						...
						{userStats?.achievements && userStats.achievements.length > 0 ? (
							...
							<View style={styles.noAchievements}>
								...
								<Text style={styles.noAchievementsSubtext}>
									Start reporting issues and engaging with the community to
									unlock achievements!
								</Text>
							</View>
						)}
