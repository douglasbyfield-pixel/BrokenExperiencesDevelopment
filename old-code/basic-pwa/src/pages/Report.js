...
const Report = () => {
	...
	const handleSubmit = async (e) => {
		...
		if (!currentLocation) {
			alert(
				"Location is required to report issues. Please enable location services.",
			);
			return;
		}
		...
		<ReportContainer>
			<Header>
				<HeaderContent>
					...
					<Subtitle>
						Help improve Jamaica by reporting community issues
					</Subtitle>
			...
			<FormContainer>
				<form onSubmit={handleSubmit}>
					...
					<FormSection>
						...
						<SectionSubtitle>
							A picture helps others understand the issue better and increases
							the chance of it being resolved
						</SectionSubtitle>
					...
					<FormSection>
						...
						<SectionSubtitle>
							How urgent is this issue? This helps prioritize community
							responses
						</SectionSubtitle>
					...
					<FormSection>
						...
						<SectionSubtitle>
							Your current location will be used to pinpoint the issue on the
							map
						</SectionSubtitle>
