        ...
        <div className="flex flex-1 flex-col lg:w-1/2">
                ...
                <div className="flex justify-center">
                    <div className="text-center">
                        <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-black bg-white p-3">
                            <img src="/favicon/be-logoimage.png" alt="Broken Experiences" className="h-full w-full object-contain" />
                        </div>
                        <h1 className="font-bold text-2xl text-black">Broken Experiences</h1>
                        <p className="mt-1 text-gray-600 text-sm">Share and discover experiences</p>
                    </div>
                </div>
            </div>
            ...
            <div className="hidden flex-shrink-0 px-12 pt-12 pb-8 lg:block">
                <div className="flex items-center space-x-3">
                    ...
                    <span className="font-bold text-black text-xl">Broken Experiences</span>
                </div>
            </div>
