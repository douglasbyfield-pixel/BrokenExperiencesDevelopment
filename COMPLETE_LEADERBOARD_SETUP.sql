-- Complete Leaderboard Setup with Working Functions and Triggers

-- 1) The award_points function you've already created (included for completeness)
...
-- 4) Create a comprehensive leaderboard view
...
SELECT public.award_points('6aab26ac-5376-4d77-8ce6-0ecbf3492911'::uuid, 'add_experience'::text, 10);

-- Check the leaderboard
SELECT * FROM public.leaderboard_display LIMIT 10;

-- Get specific user stats
SELECT * FROM public.get_user_leaderboard_stats('6aab26ac-5376-4d77-8ce6-0ecbf3492911'::uuid);
